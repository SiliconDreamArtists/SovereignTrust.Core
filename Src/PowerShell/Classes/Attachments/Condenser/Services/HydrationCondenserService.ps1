class HydrationCondenserService {
    ...
    [object] GetMergeCondenserSettings() {
        if ($this.Conductor -and $this.Conductor.MappedCondenserAttachment -and $this.Conductor.MappedCondenserAttachment.MergeCondenser) {
            return $this.Conductor.MappedCondenserAttachment.MergeCondenser.Settings
        } else {
